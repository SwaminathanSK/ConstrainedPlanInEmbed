...
# load GIFs
gif1 = Image.open('/home/swaminathan/git/vip/vip/assets/fold_towel_vip.gif')
gif2 = Image.open('/home/swaminathan/git/vip/vip/assets/kitchen_sdoor_open-v3_vip.gif')
gif3 = Image.open('/home/swaminathan/git/vip/vip/assets/task_hammer_vip.gif')
